...
As of May 21, 2026, you can open the BookID_Filler + dataset_WithID.zip file containing the dataset with complete 'book_ID' that we can use for matching and other steps.
